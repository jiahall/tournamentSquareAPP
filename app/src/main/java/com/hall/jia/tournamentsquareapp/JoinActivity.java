...
public class JoinActivity extends AppCompatActivity {
    ...
    public void hi() {
        sharedPreferences.getString("tournamentjoin","");
        Toast.makeText(getApplicationContext(), sharedPreferences.getString("tournamentjoin",""), Toast.LENGTH_LONG).show();
        startActivity(new Intent(JoinActivity.this, Joinpopup.class));
    }
}
